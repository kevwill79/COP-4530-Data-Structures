proj5: passserver.o proj5.o
	g++ -std=c++11 -o proj5 proj5.o passserver.o -lcrypt

myproj5.x: passserver.o sproj5.o
	g++ -std=c++11 -o myproj5.x myproj5.o passserver.o -lcrypt
